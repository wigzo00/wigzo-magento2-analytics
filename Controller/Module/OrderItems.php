...
use Wigzo\Service\Model\Types\OrderItemsFactory;
use Wigzo\Service\Helper\Data;

class OrderItems extends \Wigzo\Service\Controller\Module {
     ...
     * @param \Wigzo\Service\Model\Types\OrderItemsFactory $orderItemsFactory
