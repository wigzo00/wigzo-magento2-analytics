...
use Wigzo\Service\Model\Types\RefundItemsFactory;
use Wigzo\Service\Helper\Data;

class RefundItems extends \Wigzo\Service\Controller\Module {
     ...
     * @param \Wigzo\Service\Model\Types\RefundItemsFactory $refundItemsFactory
