...
use Wigzo\Service\Model\Types\SubscribersFactory;
use Wigzo\Service\Helper\Data;

class NewsletterSubscribers extends \Wigzo\Service\Controller\Module {
     ...
     * @param \Wigzo\Service\Model\Types\SubscribersFactory $subscribersFactory
