...
use Wigzo\Service\Model\Types\ProductsFactory;
use Wigzo\Service\Helper\Data;

class Products extends \Wigzo\Service\Controller\Module {
     ...
     * @param \Wigzo\Service\Model\Types\ProductsFactory $productsFactory
